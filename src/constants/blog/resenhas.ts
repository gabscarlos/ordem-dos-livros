const resenhas = [
    {
        id: "outlander",
        data: "02-01-2025",
        titulo: "Outlander: Uma Jornada pelo Tempo e pelo Amor",
        ...
        descricao: "Romance histórico, viagem no tempo, aventura.",
        conteudo: `
# Outlander
      
**Outlander**, escrito por **Diana Gabaldon**, é o primeiro volume de uma série de livros que combina romance histórico, fantasia e aventura. Publicado originalmente em 1991, o livro transporta os leitores para o século XVIII, enquanto explora temas de amor, lealdade e sobrevivência em tempos de guerra.
      
## Sinopse
A história começa em 1945, quando a enfermeira Claire Beauchamp Randall está em uma segunda lua de mel na Escócia com seu marido, Frank Randall, após o término da Segunda Guerra Mundial. Durante uma caminhada, Claire toca em um círculo de pedras antigas chamado Craigh na Dun e é misteriosamente transportada para o ano de 1743.
      
Neste novo e perigoso contexto, Claire se vê em meio a conflitos entre clãs escoceses e forças inglesas. Sua habilidade médica rapidamente a torna indispensável, mas ela também chama a atenção de Jamie Fraser, um jovem guerreiro escocês. O romance entre Claire e Jamie floresce, desafiando os limites do tempo e os compromissos de Claire no século XX.
      
## Temas Principais
- **Viagem no Tempo:** A narrativa explora as consequências emocionais e práticas de ser arrancado de sua era.
- **Romance e Lealdade:** A relação entre Claire e Jamie é o coração da história, repleta de desafios e intensidade.
- **História e Cultura:** O livro mergulha na rica cultura escocesa e no contexto político dos levantes jacobitas.
      
## Destaques
A obra de Gabaldon é conhecida por sua pesquisa histórica minuciosa e descrições vívidas. O cenário das Terras Altas escocesas é quase um personagem por si só, oferecendo um pano de fundo envolvente para os eventos dramáticos da trama.
      
## Adaptação
Em 2014, *Outlander* foi adaptado para a televisão em uma série de grande sucesso produzida pela Starz. A série recebeu elogios por sua fidelidade ao material original e pelo desempenho de seus atores principais, Caitriona Balfe (Claire) e Sam Heughan (Jamie).
      
## Conclusão
*Outlander* é uma leitura indispensável para fãs de romances históricos e histórias que desafiam os limites do tempo e do amor. A mistura de aventura, paixão e cultura torna o livro uma experiência cativante.
