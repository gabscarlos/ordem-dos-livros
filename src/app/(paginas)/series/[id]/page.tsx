  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content={`Explore a série "${titulo}" escrita por ${autorNome}. ${descricao}`}
        />
        <meta
          name="keywords"
          content={`${titulo}, livros, série de livros, ${autorNome}, literatura`}
        />
        ...
        <meta
          property="og:url"
          content={`https://aordemdoslivros.vercel.app/series/${serieEspecifica.id}`}
        />
        ...
        <link
          rel="canonical"
          href={`https://aordemdoslivros.vercel.app/series/${serieEspecifica.id}`}
        />
